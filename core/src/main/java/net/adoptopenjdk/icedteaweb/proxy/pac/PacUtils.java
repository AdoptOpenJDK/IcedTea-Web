...
import static net.adoptopenjdk.icedteaweb.proxy.pac.PacConstants.DIRECT;
import static net.adoptopenjdk.icedteaweb.proxy.pac.PacConstants.PROXY;
import static net.adoptopenjdk.icedteaweb.proxy.pac.PacConstants.SOCKS;

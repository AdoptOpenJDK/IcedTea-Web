...
import static net.adoptopenjdk.icedteaweb.proxy.linux.LinuxProxyProviderConstants.GNOME_PROXY_HTTP_HOST;
...
import static net.adoptopenjdk.icedteaweb.proxy.linux.LinuxProxyProviderConstants.GNOME_PROXY_USE_AUTHENTICATION;
...
class GnomeProxyConfigReader {
    ...
    public static Optional<LinuxProxySettings> readGnomeProxyConfig(final ExecutorService ioExecutor) {
        try {

package net.adoptopenjdk.icedteaweb.proxy.config;
...
import static net.adoptopenjdk.icedteaweb.proxy.util.CidrUtils.isCidrNotation;
import static net.adoptopenjdk.icedteaweb.proxy.util.CidrUtils.isInRange;
import static net.adoptopenjdk.icedteaweb.proxy.util.CidrUtils.isIpv4;
import static net.adoptopenjdk.icedteaweb.proxy.util.ProxyConstants.FTP_SCHEMA;
import static net.adoptopenjdk.icedteaweb.proxy.util.ProxyConstants.HTTPS_SCHEMA;
import static net.adoptopenjdk.icedteaweb.proxy.util.ProxyConstants.HTTP_SCHEMA;
import static net.adoptopenjdk.icedteaweb.proxy.util.ProxyConstants.SOCKET_SCHEMA;

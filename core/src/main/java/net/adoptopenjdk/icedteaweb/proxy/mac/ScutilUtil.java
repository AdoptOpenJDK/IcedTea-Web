...
import net.adoptopenjdk.icedteaweb.process.ProcessResult;
import net.adoptopenjdk.icedteaweb.process.ProcessUtil;
...
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.AUTO_CONFIG_ENABLED_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.AUTO_CONFIG_URL_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.AUTO_DISCOVERY_ENABLE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.EXCEPTIONS_LIST_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.EXCLUDE_SIMPLE_HOSTNAMES_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.FTP_ENABLE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.FTP_PASSIVE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.FTP_PORT_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.FTP_PROXY_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.FTP_USER_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTPS_ENABLE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTPS_PORT_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTPS_PROXY_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTPS_USER_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTP_ENABLE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTP_PORT_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTP_PROXY_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.HTTP_USER_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.SOCKS_ENABLE_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.SOCKS_PORT_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.SOCKS_PROXY_PROPERTY_NAME;
import static net.adoptopenjdk.icedteaweb.proxy.mac.MacProxyProviderConstants.SOCKS_USER_PROPERTY_NAME;

public class ScutilUtil {

    private static final Logger LOG = LoggerFactory.getLogger(ScutilUtil.class);

    public static MacProxySettings executeScutil(final ExecutorService ioExecutor) throws Exception {
        final ProcessBuilder processBuilder = new ProcessBuilder("scutil", "--proxy");
        final ProcessResult processResult = ProcessUtil.runProcess(processBuilder, 5, TimeUnit.SECONDS, ioExecutor);

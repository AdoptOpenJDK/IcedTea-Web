...
public class DefaultDownloadIndicator implements DownloadIndicator {
    ...
    private static final String downloading = R("CDownloading");
    private static final String complete = R("CComplete");
    ...
    /** shared constraint */
    private static final GridBagConstraints vertical;
    private static final GridBagConstraints verticalNoClean;
    private static final GridBagConstraints verticalIndent;
    static {
     ...
     * @return download service listener attached to this app. instance
     */
    @Override
    ...
    static class DownloadPanel extends JPanel implements DownloadServiceListener {
        ...
        private final List<ProgressPanel> panels = new ArrayList<>();
        ...
        protected void addProgressPanel(URL url, String version) {
            if (!urls.contains(url)) {
                ...
                //When only one jar is added to download queue then its progress is
    ...
    static class ProgressPanel extends JPanel {
        ...
        ProgressPanel(URL url, @SuppressWarnings("unused") String version) {
            bar.setMinimumSize(size);
            bar.setPreferredSize(size);
            bar.setOpaque(false);

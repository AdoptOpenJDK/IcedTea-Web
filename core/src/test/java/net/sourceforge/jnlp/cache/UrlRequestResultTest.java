...
public class UrlRequestResultTest {
    ...
    public void testUrlRequestResultIsRedirect() throws MalformedURLException {
        final UrlRequestResult urlRequestResult = new UrlRequestResult(303, new URL("https://some.url.com"), new Date().getTime(), 42);
   ...
   @Test
    public void testUrlRequestResultIsNoRedirect() throws MalformedURLException {
        final UrlRequestResult urlRequestResult = new UrlRequestResult(201, new URL("https://some.url.com"), new Date().getTime(), 42);
    ...
    public void testUrlRequestResultIsIllegalRedirect() {
        final UrlRequestResult urlRequestResult = new UrlRequestResult(301, null, new Date().getTime(), 42);
   ...
   @Test
    ...
    public void testUrlRequestResultIsNoSuccess() {
        final UrlRequestResult urlRequestResult = new UrlRequestResult(500, null, new Date().getTime(), 42);

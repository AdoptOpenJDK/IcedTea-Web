...
public class Base64UtilTests {
    ...
    public void testEmbededBase64Decoder() throws Exception {
        ...
        //then
        final String utfData = new String(decoded, "utf-8");
        Assert.assertEquals(UTF_STRING, utfData);
    }
    ...
    public void testEmbededBase64Encoder() throws Exception {
        ...
        //then
        final byte[] encodedData = getEncodedData();


        Assert.assertArrayEquals(encodedData, encoded);
    }

    @Test
    public void testEmbededDecoderAgainstEmbededEncoder() throws Exception {
        //given
        final byte[] data = getEncodedData();
        final ByteArrayInputStream in = new ByteArrayInputStream(data);
    ...
    @Test
    public void testEmbededEncoderAgainstEmbededDecoder() throws Exception {
        //given
        final byte[] data = UTF_STRING.getBytes("utf-8");
        final ByteArrayOutputStream out = new ByteArrayOutputStream();
        ...
        //then
        final String decodedUtf8 = new String(decoded, "utf-8");
        Assert.assertEquals(UTF_STRING, decodedUtf8);
    }
}

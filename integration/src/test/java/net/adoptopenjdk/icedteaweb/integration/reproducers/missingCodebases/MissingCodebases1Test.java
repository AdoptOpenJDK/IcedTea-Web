...
public class MissingCodebases1Test implements IntegrationTest {
    ...
    public void codebaseDotHrefFull() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebases1.jnlp", MissingCodebases.class, JAR_NAME);

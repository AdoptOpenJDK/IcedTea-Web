...
public class MissingCodebases2Test implements IntegrationTest {
    ...
    public void codebaseEmptyHrefFull() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebases2.jnlp", MissingCodebases.class, JAR_NAME);

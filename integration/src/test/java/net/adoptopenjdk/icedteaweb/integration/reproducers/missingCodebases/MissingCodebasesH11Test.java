...
public class MissingCodebasesH11Test implements IntegrationTest {
    ...
    public void codebaseDotHrefNoneApp() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebasesH11.jnlp", MissingCodebases.class, JAR_NAME);

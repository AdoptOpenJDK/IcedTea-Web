...
public class AppletDescMainClassWithClass2Test implements IntegrationTest {
    ...
    public void appletWithDotClassSuffixedMainClass() throws IOException {
        ...
        final String jnlpUrl = setupServer(wireMock)
                .servingJnlp("AppletDescMainClassWithClass2.jnlp").withMainClass(AppletDescMainClassWithClass.class)

...
public class MissingCodebases0Test implements IntegrationTest {
    ...
    public void codebaseFullHrefFull() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebases0.jnlp", MissingCodebases.class, JAR_NAME);

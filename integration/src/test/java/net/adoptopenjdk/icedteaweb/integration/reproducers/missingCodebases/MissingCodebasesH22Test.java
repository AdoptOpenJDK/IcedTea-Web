...
public class MissingCodebasesH22Test implements IntegrationTest {
    ...
    public void codebaseEmptyHrefnoneApp() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebasesH22.jnlp", MissingCodebases.class, JAR_NAME);

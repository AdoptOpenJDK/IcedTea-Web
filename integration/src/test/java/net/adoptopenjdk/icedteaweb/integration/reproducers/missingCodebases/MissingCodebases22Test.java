...
public class MissingCodebases22Test implements IntegrationTest {
    ...
    public void codebaseEmptyHrefFullApp() throws IOException {
        // given
        final String jnlpUrl = setupServer(wireMock, "MissingCodebases22.jnlp", MissingCodebases.class, JAR_NAME);
